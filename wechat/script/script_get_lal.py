...
for kv in data.items():
    ...
    sql = """INSERT INTO wechat_citylal(city,province,country,
                         lng,lat)
                         VALUES ('%s','none','中国','%s','%s')"""
    data_tuple = (kv[0], kv_lal[0], kv_lal[1])
    try:
...
#             kv_lal = list(kv[1])
#
#             sql = """INSERT INTO wechat_citylal(
#                     lng,lat,country)
#                     VALUES ('%s','%s','%s')"""
#             data_tuple = (kv[0], kv_lal[0], kv_lal[1])
#             try:
